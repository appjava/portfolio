...
Hola, soy
${meName} <a href="/" target="" rel="noopener" class="flex justify-center items-center"> ${renderComponent($$result3, "Badge", $$Badge, {}, { "default": ($$result4) => renderTemplate`Disponible` })} </a> </h1> <h2 class="text-xl lg:text-2xl text-wrap max-w-[760px] min-w-[285px]">
Modelador 3D, Programador y Diseñador Mecatrónico. <span class="text-red-200/50">De Cali, Colombia.</span>
Con experiencia en soluciones tecnológicas escalables, eficientes y sostenibles.
<span class="opacity-60">Especialista en energías renovables y desarrollo de prototipos mecatrónicos innovadores.
				Enfocado en transformar ideas en productos funcionales y confiables que impulsen la sostenibilidad en el sector tecnológico.</span> </h2> <nav class="flex gap-3 mt-6 flex-wrap"> ${renderComponent($$result3, "SocialPill", $$SocialPill, { "href": "https://github.com/appjava" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "GitHubIcon", $$GitHub, { "class": "size-5" })} ` })} ${renderComponent($$result3, "SocialPill", $$SocialPill, { "href": "https://www.linkedin.com" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "LinkedlnIcon", $$Linkedln, { "class": "size-5" })} ` })} ${renderComponent($$result3, "SocialPill", $$SocialPill, { "href": "https://mastodon.social/@appjavadev" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "MastodonIcon", $$Mastodon, { "class": "size-5" })} ` })} ${renderComponent($$result3, "SocialPill", $$SocialPill, { "href": "mailto:projects.appjavadev@gmail.com" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "MailIcon", $$Mail, { "class": "size-5" })}
...
}, "/Users/javaair/mePROJECTS/AstroProjects/portfolio-dev/src/pages/index.astro", void 0);

const $$file = "/Users/javaair/mePROJECTS/AstroProjects/portfolio-dev/src/pages/index.astro";
const $$url = "";
